    ...
    public BoardProva() throws SQLException {
        ...
        for(int i=0;i<NSQUARES;i++){
            ...
            if(i==1 || i==10 || i==19 || i==28){
                ...
                possibleQuestionGeo.addAll(creaDomandaDiProva("provaGeo","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==2 || i==11 || i==20|| i==29){
                ...
                possibleQuestionArt.addAll(creaDomandaDiProva("provaArt","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==3 || i==13 || i==22|| i==31) {
                ...
                possibleQuestionSci.addAll(creaDomandaDiProva("provaSci","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==7 || i==16 || i==25|| i==34){
                ...
                possibleQuestionSpo.addAll(creaDomandaDiProva("provaSpo","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==4|| i==15 || i==24 || i==33) {
                ...
                possibleQuestionSpe.addAll(creaDomandaDiProva("provaSpe","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==8|| i==17|| i==26 || i==35){
                ...
                possibleQuestionSto.addAll(creaDomandaDiProva("provaSto","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==5){
                ...
                possibleQuestionSpoFinal.addAll(creaDomandaDiProva("provaSpoFinal","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==9){
                ...
                possibleQuestionArtFinal.addAll(creaDomandaDiProva("provaArtFinal","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==14){
                ...
                possibleQuestionShowFinal.addAll(creaDomandaDiProva("provaShowFinal","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==23){
                ...
                possibleQuestionStoFinal.addAll(creaDomandaDiProva("provaStoFinal","A",true,"b",false,"c",false,"d",false));
            ...
            if(i==27){
                ...
                possibleQuestionScieFinal.addAll(creaDomandaDiProva("provaSciFinal","A",true,"b",false,"c",false,"d",false));
