...
public class ConnectionDB {
    ...
    public ArrayList<Question> getQuestion (String cod) throws SQLException{
        ...
        cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/trivial?useSSL=false", "root", "root");
...
//-------------------------------------------------------------------------------
    ...
    public Boolean getPlayer(String IDNAME, String PW) {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/trivial?useSSL=false", "root", "winchester96");
