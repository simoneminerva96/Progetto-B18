...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `PLAYER_EXIST`(codice varchar(100), pass varchar(100)) RETURNS varchar(300) CHARSET utf8
BEGIN
	declare choose varchar(300);
...
BEGIN
    ...
    declare CONT int;
    declare exit handler for 1062 select CONCAT('Errore il nome (',IDNAME,') esiste') AS msg;
